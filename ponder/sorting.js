...
let simpleSort = simpleList.map(function(fruit) {return fruit.toLowerCase()}).sort();
...
function searchList(list, query) {
  ...
  function searchItemList(list, q) {
  ...
  console.log(searchItemList(hikes, "yellowstone"));
  console.log(searchItemList(hikes, "moderate"));
  console.log(searchItemList(hikes, "al"));

  console.log(searchItemList(hikes, "fall"));